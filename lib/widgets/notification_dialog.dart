  ...
  checkAvailabilityOfTripRequest(BuildContext context) async {
    ...
    await driverTripStatusRef.once().then((snap) {
      ...
      if (snap.snapshot.value != null) {
        ...
        cMethods.displaySnackBar("Không tìm thấy chuyến nào.", context);
      }
      ...
      if (newTripStatusValue == widget.tripDetailsInfo!.tripID) {
        ...
        cMethods.displaySnackBar("Yêu cầu đã bị hủy bởi khách.", context);
      } else if (newTripStatusValue == "timeout") {
        cMethods.displaySnackBar("Hết thời gian.", context);
      } else {
        cMethods.displaySnackBar("Yêu cầu bị hủy!", context);
      }
    });
  }
