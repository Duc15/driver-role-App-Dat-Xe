...
class _HomePageState extends State<HomePage> {
  ...
  String titleToShow = "Bật nhận chuyến";
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  Text(
                                    (!isDriverAvailable)
                                        ? "Bạn sẽ vào trạng thái nhận chuyến, bạn sẽ nhận được yêu cầu từ khách hàng."
                                        : "Bạn sẽ tắt trạng thái nhận chuyến, bạn sẽ không nhận được yêu cầu từ khách hàng.",
                                    textAlign: TextAlign.center,
                                    style: const TextStyle(
